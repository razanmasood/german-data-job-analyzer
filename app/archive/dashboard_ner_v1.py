# V1 Dashboard — Fine-tuned xlm-roberta-large NER (F1=0.666)
# Archived after v2 LangExtract dashboard was built.
# Kept for reference — demonstrates the full fine-tuning pipeline.
# To run: streamlit run app/archive/dashboard_ner_v1.py
